      ...
      *** Revision History                                            *
      ***-------------------------------------------------------------*
      ***  $Log: mfmemqlist40.cbl,v $
      ***  Revision 1.0  2006/05/11 14:04:06  LB 
      ***  lb-001 - Copy of mfmemqlist.cbl which uses a pre 5.0 version 
      ***           of dfhcbcfa.cpy that has a smaller configuration for the 
      ***           Cfg-area. This program will be called by mfmemclean and 
      ***           mfmemlist if a COBDIR is pointing to a 4.0 Server Express 
      ***           product.
      ***
      *** Build instructions (UNIX only):
      *** cob -i mfmemqlist40.cbl -C "constant OSMCO\"UNIX\""
      ***
      ***
...
asee01   *> ---------------------------------------------------------
         01 CfgArea.
            02 Cfg-System-Area.
               03 Cfg-Path-Vars.
                  05 Cfg-TRANPATH  pic x(78-max-line-length).
                  05 Cfg-MAPPATH   pic x(78-max-line-length).
                  05 Cfg-FILEPATH  pic x(78-max-line-length).
                  05 Cfg-LOGDIR    pic x(78-max-line-length).
                  05 Cfg-FHREDIR   pic x(78-max-line-length).
                  05 Cfg-RDTDIR    pic x(78-max-line-length).
                  05 Cfg-RGBASE    pic x(78-max-line-length).
P18262            05 Cfg-TXRFDIR   pic x(78-max-line-length).
               03  redefines Cfg-Path-Vars.
                  05 Cfg-Path      pic x(78-max-line-length)
